...
export default function Home() {
  ...
  return (
    <main>
      <section className="relative h-[600px] overflow-hidden">
        ...
        <div className="relative container mx-auto px-4 h-full flex flex-col items-center justify-center text-white text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-6">
            <Button
              size="lg"
              className="group bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text px-8 py-6 rounder-xl"
            >
            ...
            <Button
              size="lg"
              className="group bg-gradient-to-r from-yellow-500 to-yellow-600 hover:from-yellow-600 hover:to-yellow-700 text-black px-8 py-6 rounder-xl"
            >
              <div className="flex items-center gap-3">
      ...
      <Button
        size="lg"
        className="flex mt-10 mx-auto bg-yellow-500 px-8 py-6 rounded-xl hover:bg-black hover:text-white transition-all"
      >
        <Link href="/books">
