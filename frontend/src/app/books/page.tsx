...
export default function Books() {
  ...
  const paginatedBooks = filterBooks.slice(
                          ...
                          <Link href={`/books/${book._id}`}>
                            <div className="relative">
                              ...
                              <Button
                                size="icon"
                                variant="ghost"
                                className="absolute right-2 top-2 h-8 rounded-full bg-white/80 backdrop-blur-sm transition-opacity duration-300 hover:bg-white group-hover:opacity-100"
                              >
